export const zhTW: Record<string, string> = {
  ...
  "sidebar.shortcutsTitle": "側欄快捷鍵",
  "sidebar.shortcutsDismiss": "Esc 關閉",
  "sidebar.shortcutFocus": "跳到側欄",
  "sidebar.shortcutNavigate": "移動焦點",
  "sidebar.shortcutTree": "收合、展開、進入樹狀項目",
  "sidebar.shortcutOpen": "啟用 session／切換 workspace",
  "sidebar.shortcutManage": "改名／新增 session／新增 workspace／設定資料夾",
  "sidebar.shortcutDelete": "刪除後確認／取消",
