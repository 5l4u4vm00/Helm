export const zhTW: Record<string, string> = {
  ...
  "workspaceRecipe.dialogLabel": "{name} 的啟動設定",
  "workspaceRecipe.title": "啟動設定 — {name}",
  "workspaceRecipe.hint": "在這個 Workspace 新增 session 時套用；已經在跑的 session 不受影響。",
  "workspaceRecipe.envHeading": "環境變數",
  "workspaceRecipe.envHint": "傳給這個 Workspace 的每個新 session。{keys} 由 Helm 自己設定，不可覆寫。",
  "workspaceRecipe.envKeyPlaceholder": "名稱",
  "workspaceRecipe.envValuePlaceholder": "值",
  "workspaceRecipe.addEnv": "＋ 新增變數",
  "workspaceRecipe.removeEnv": "移除這個變數",
  "workspaceRecipe.commandHeading": "啟動指令",
  "workspaceRecipe.commandHint":
    "在此新增 session 時送進 shell。從 launcher 選單挑 agent 時讓位給 launcher；還原與開啟資料夾時一律不執行。",
  "workspaceRecipe.commandPlaceholder": "claude",
  "workspaceRecipe.errorNoKey": "請填寫變數名稱，或移除這一列。",
  "workspaceRecipe.errorBadKey": "只能用英文字母、數字與底線，且不可用數字開頭。",
  "workspaceRecipe.errorReservedKey": "這個變數由 Helm 自己設定，請換一個名稱。",
  "workspaceRecipe.errorDuplicateKey": "上面已經設定過這個變數了。",
  "workspaceRecipe.cancel": "取消",
  "workspaceRecipe.save": "儲存",
};
