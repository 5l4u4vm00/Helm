export const en: Record<string, string> = {
  ...
  "sidebar.shortcutsTitle": "Sidebar shortcuts",
  "sidebar.shortcutsDismiss": "Esc to close",
  "sidebar.shortcutFocus": "Focus sidebar",
  "sidebar.shortcutNavigate": "Move focus",
  "sidebar.shortcutTree": "Collapse, expand, and enter tree items",
  "sidebar.shortcutOpen": "Activate session / toggle workspace",
  "sidebar.shortcutManage": "Rename / new session / new workspace / set folder",
  "sidebar.shortcutDelete": "Delete, then confirm / cancel",
